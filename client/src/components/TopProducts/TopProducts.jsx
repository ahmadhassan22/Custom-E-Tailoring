...
const ProductsData = [
    {
        ...
        img: Img1,
        title: "Casual Wear",
        description: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptate rerum qui aspernatur iusto pariatur dolor",
    },
...
const TopProducts = () => {
  useEffect(() => {
    AOS.init({ duration: 2000 }); // Customize duration as needed
  }, []);
    ...
    <div>
      <div className='container'>
        ...
        <div className='text-left mb-24'>
          ...
          <p data-aos="fade-up" className='text-xs text-gray-400'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sequi soluta porro laboriosam.</p>
        </div>
        {/* Body Section */}
        <div
                ...
                ProductsData.map((data) =>(
                    ...
                    group max-w[300px]'> 
                        ...
                        <div className='p-4 text-center'>
                            ...
                            group-hover:text-primary hover:dark:text-black'
